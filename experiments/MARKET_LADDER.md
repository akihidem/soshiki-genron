...
4ティア（gemma4:e2b < haiku < sonnet < opus）を検算済み難タスクに当て、各タスクを *最強の解けるティア* で分類（trials=2・gold は外部正解）。市場の支配定理は強ティアが解ける(p_strong=1)前提 ── impossible 帯はその前提が崩れる所。

## タスク別 solve_rate（1.0到達率）と帯
| task | gemma4:e2b | haiku | sonnet | opus | 最安の解き手 | 帯 |
|---|---|---|---|---|---|---|
| calc3 | 0.5 | 1.0 | 1.0 | 1.0 | gemma4:e2b | **easy** |
| atoms | 0.0 | 1.0 | 1.0 | 1.0 | haiku | **gemma-gap** |
| wildcard_plus | 1.0 | 1.0 | 1.0 | 1.0 | gemma4:e2b | **easy** |
| negabinary | 1.0 | 0.5 | 1.0 | 1.0 | gemma4:e2b | **easy** |
